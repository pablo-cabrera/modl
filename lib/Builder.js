...
module.exports = ilk.tokens(function (
    ...
    proto(fetchJson, function () {
        this[json] = this[pathExists]("module.json")?
            JSON.parse(this[fetch]("module.json")):
            {};
    ...
    proto(pathExists, parts.args(function (args) {
        try {
    ...
    proto(fetchAssets, parts.that(function (that) {
        ...
        if (!("/module" in this[assets])) {
            this[assets]["/module"] = this[pathExists]("module.js")?
                this[fetch]("module.js"):
                "modl.unit(function () {});";
        }
    })).
    ...
    proto(modulePath, function () {
        return this[parent] === null?
            ...
            this[name]:
            parts.format("%s/%s",
                    [this[parent][modulePath](), this[name]]);
    }).
    ...
    proto({
        ...
        build: function () {
            ...
            return parts.format("modl.$module(%s);", [this[assemble]()]);
        }
